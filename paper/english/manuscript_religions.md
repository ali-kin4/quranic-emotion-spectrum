...
Existing scholarship treats the Qur'an's lexicon of anger word-by-word or through normative-ethical frames. This study argues that fourteen core Arabic roots form a graded semantic field ordered by intensity of action across six phenomenological stages: pre-anger displeasure, inner pressure, evaluative aversion, active anger, compressed/explosive rage, and behavioural outcomes. The framework layers Kennedy–Sassoon scalar semantics onto Izutsu's semantic-field method and Lakoff–Kövecses conceptual metaphor theory; its signature theoretical claim is that Q. 67:8 of sūrat al-Mulk (*takādu tamayyazu min al-ghayẓ*) lexicalises an internal-separation, vessel-internal-failure variant of the PRESSURIZED-CONTAINER ANGER metaphor, distinct from the exit/overflow exemplars of the Anglo cognitive-linguistic canon. A reproducible pipeline over the Quranic Arabic Corpus yields 312 attestations; the distributional tests are corroborative and partly null (permutation *p* = 0.24; three roots survive Holm-Bonferroni, *sakhaṭ* a near-miss at adj. *p* = 0.0505), so the architecture is licensed chiefly by lexicography and *tafsīr*. *Baghy* is the largest cross-field bridge to the moral-evaluation field; a *tafsīr*-coding audit (second-coder κ = 0.79, 20% sample) supports bidirectional Stage-6 causation. Theologically, the affective-embodied upper register (*ghayẓ*, Q. 67:8) is reserved for creatures, while only action-tilted aversion lexemes are predicated of God. Small per-root *n* and the closed corpus bound the inferences.
...
This paper combines Izutsu's semantic-field approach, Kennedy–Sassoon scalar semantics, and Lakoff–Kövecses CMT to produce richer philological claims than any framework in isolation, with an honest division of labour: lexicographic evidence (organised via Izutsu) supplies the *ordering* of the roots; scalar semantics supplies the single-graded-dimension *model* that licenses reading the ordering as a continuum and partitioning it into stages; CMT grounds the pressurisation-collapse complex metaphor that organises Stages 4–5. Izutsu's method yields a network without an internal ordering; Lakoff–Kövecses supply an English-anchored cognitive schema, and the two-volume *Metaphors of ANGER across Languages* (Kövecses, Benczes, and Szelid 2025) does not canvass Classical Arabic; Kennedy–Sassoon orders predicates along a dimension but has not been applied to a Qur'anic emotion field. We flag at the outset that the scalar layer functions here as a degree-semantic vocabulary for an ordering that is itself recovered from lexicography rather than from a corpus-validated metric; the corpus apparatus is corroborative (and, at several tests, candidly null — see Sections 3.2.1 and 3.11), not the primary evidentiary engine. Qāʾimīniyā (2011, 2014) and Pakatchi and Afrashi (2020) already integrate Izutsu with CMT in Persian; the novel element here is the scalar layer operationalised as a six-stage continuum and tested against a 312-attestation reproducible pipeline, alongside (i) a *tafsīr*-coding audit of the bidirectional-causation reading of Stage 6 (second-coder κ = 0.79 on a 20% verification sample), (ii) the *kaẓm*-as-tying-off-of-waterskin analysis of agent-internal containment, and (iii) the framing of Q. 67:8 of sūrat al-Mulk as an early and unusually transparent exemplification of vessel-internal failure, calibrated against the six-tradition survey of Section 4.5 acknowledging Job 32:19 (*bāqaʿ*) as a structurally cognate Northwest-Semitic precedent. The interpretive payoff: the continuum constitutes a coherent logic of escalation with structural affinities to modern emotion psychology, and reaches at Stage 6 into a moral-anthropological register that lies beyond the episode-bounded scope of process models such as Gross's, where *baghy*/*ṭughyān*/*ʿutuww* extend the regulatory horizon into questions of settled character. These affinities are read comparatively, not as a claim that the Qur'an anticipates or contains modern theory (Section 4.2).

### 1.3. Prior Work and the Gap

Prior scholarship clusters into five lines. *Single-word lexical studies* (Narimani, Iqbali, and Chari 2021 on *ghayẓ/ghaḍab/sakhaṭ*; Khaleefah 2016, a semiotic study of the same three core terms; Qarizadeh et al. 2024 on *ṭughyān*) supply high-quality per-lexeme analysis but no integrated continuum. *Semantic-field and cognitive-semantic studies* in the Izutsu tradition (Qāʾimīniyā 2011, 2014; Pakatchi and Afrashi 2020; Solihu 2009; Albayrak 2012) leave the graded-continuum layer untreated. *Ethics-of-anger* work in the *kaẓm al-ghayẓ* tradition is normatively rich and linguistically thin. *Cross-linguistic CMT* literature, updated by Kövecses, Benczes, and Szelid (2025) across twenty-two languages, omits Classical Arabic; the closest Arabic-CMT precedents (Maalej 2004, 2007; Rabab'ah and Al-Saidat 2022) treat contemporary dialects. *Historical-critical and corpus-linguistic* work supplies complementary apparatus (Sinai 2017, 2023; Neuwirth 2019; El-Awa 2006; Sharaf and Atwell 2012a, 2012b; Akra, Hammouda, and Jarrar 2025; Sawalha et al. 2024); translation-criticism is now quantitative at scale (Gaanoun and Alsuhaibani 2025; Al-Shidi et al. 2025) but lacks a graded lexeme-level reference model. The present study occupies the unfilled intersection: it adds the Kennedy–Sassoon scalar layer to the Izutsu/CMT stack, applies it to the anger field the 2025 *Metaphors of ANGER* encyclopedia leaves un-canvassed, and releases the pipeline under Sharaf–Atwell / QuranMorph reproducibility standards.
...
Gradable-predicate theory (Kennedy 1999, 2007; Sassoon 2010) supplies the missing apparatus. On the standard formulation a scale comprises a *dimension* of measurement, an *ordering*, and a *degree structure* recovered by a measure function. The Qur'anic anger field is modelled as such a scale: dimension = intensity of action (decomposable into locus, experiential intensity, scope of consequence); ordering = the six-stage progression; the degrees are read off as the degree of externalisation from inner phenomenology to social rupture. Without this framework, the claim that *ghayẓ* is "more intense than" *ghaḍab* relies on tacit native-speaker intuition. Two honest qualifications attach to the transplant. *First*, Kennedy–Sassoon was developed for gradable adjectives, whereas the present field is morphologically heterogeneous (verbs, nouns — *ghaḍab* is ~67% nominal — and participles); the extension assumes a category-neutral underlying intensity scale recoverable from lexicographic and corpus-distributional evidence, an assumption we adopt as a working heuristic rather than establish as formal cross-category degree semantics. We accordingly use the scalar apparatus as an ordering *vocabulary* layered onto an ordering that the lexicographic tradition already encodes (Section 3.1), not as an independent measurement claim. *Second*, the scale so understood predicts an ordering of *semantic intensity*, which is logically independent of attestation *frequency* and of distributional clustering; the flat monotonic-trend results (Section 3.2.1) and the below-random embedding NMI (Section 3.11) therefore neither corroborate nor falsify it — they bear on a different quantity — and we read them as orthogonal rather than as evidence against the continuum.
...
The three frameworks contribute distinct, separable work, and stating the per-framework counterfactual keeps the synthesis honest. *Izutsu* identifies the field boundaries and, through the lexicographic tradition his method organises, supplies the pairwise ordering of the roots; without it there is no principled membership and no internal ranking. *Scalar semantics* supplies the single-graded-dimension model under which that ordering is read as one continuum and partitioned into discrete stages; without it the ordering would remain a loose family-resemblance network rather than a graded continuum, and the "more intense than" relations would lack a unifying dimension. *CMT* grounds the pressurisation-collapse complex metaphor organising Stages 4–5 (*ghaḍab → ghayẓ + kaẓm → tamayyuz*); without it the Q. 3:134 / Q. 67:8 container phenomenon would be describable only as disconnected idiom. The integration is thus a layered complementarity rather than a tight mutual entailment: lexicography and Izutsu do the ordering and licence the partition, scalar semantics models the graded dimension, and CMT illuminates the upper-stage container complex. Figure 1 schematises the resulting six-stage continuum.
...
Quantitative tests beyond frequency tabulation: (a) χ²(5) and χ²(1) on uniform-stage and S1–5/S6 nulls, with a marginal-preserving permutation null (Cochran 1954; Patefield 1981; Mehta and Patel 1983; Agresti 2013, §3.5);[^perm-note] (b) three monotonic-trend tests (Spearman ρ, Mann–Kendall, Cochran–Armitage-style OLS slope); (c) two-sided exact binomials against the 0.74 Meccan-ayat baseline, Holm–Bonferroni-adjusted (the Holm procedure controls the family-wise error rate, not the false-discovery rate) over the family of fourteen per-root tests, with sensitivity tables at baselines 0.70–0.78 and a family-size sensitivity check;[^family-size] (d) morphological breakdown by POS; (e) aya-level co-occurrence network (cf. Mottaghi et al. 2024) with weighted degree, betweenness, closeness, and eigenvector centrality, bootstrap 95% percentile CIs (1,000 ayat-resamples; fixed RNG seed).
...
[^family-size]: The reported family size of fourteen is the per-root Meccan/Medinan binomial family. A strict reading would expand the family to ≈ 20 (adding the omnibus χ²(5), S1–5/S6 χ²(1), three trend tests, and A-only re-analysis). Under the strict family, *karh* and *baghy* remain below α = 0.05; *ghayẓ* moves from adj. ≈ 0.019 to 0.027 (still significant); *sakhaṭ* is already non-significant under the fourteen-test family (adj. 0.0505) and moves to ≈ 0.075 under the strict family (substantively informative but not significant under either definition — see Section 3.5.2). Conclusions of Sections 3.5–3.8 are robust to the family-size choice.

### 2.6. Qualitative Analyses

Qualitative complements: (a) comparative etymology across the four lexica (Table 1); (b) comparative *tafsīr* drawing on a panel of classical and modern commentaries, with seven engaged *ad loc.* on the contested verses analysed in the Results — al-Ṭabarī (*Jāmiʿ al-bayān*), al-Zamakhsharī (*al-Kashshāf*), al-Ṭabarsī (*Majmaʿ al-Bayān*), al-Qurṭubī (*al-Jāmiʿ*), al-Rāzī (*Mafātīḥ al-Ghayb*), al-Ṭabāṭabāʾī (*al-Mīzān*), and Ibn ʿĀshūr (*al-Taḥrīr wa-l-Tanwīr*) — supplemented by al-Qushayrī's *Laṭāʾif al-Ishārāt* for a Sufi cross-check on *kaẓm al-ghayẓ* (Section 4.2). Ibn Kathīr's *Tafsīr al-Qurʾān al-ʿAẓīm*, Sayyid Quṭb's *Fī Ẓilāl al-Qurʾān*, and the ʿAbduh–Riḍā *al-Manār* were consulted as background but are not engaged at named loci below and are cited only where relevant; we therefore do not claim them as part of the *ad loc.* comparative base. (c) phenomenological analysis of contextual markers (*ḍīq al-ṣadr*, *ḥuzn al-qalb*, *ḍāqa dharʿan*); (d) illustrative translation-criticism on five English translations at canonical exemplar verses (Section 3.10).
...
| 3 | m-q-t | *al-bughḍ*: intense aversion and detestation | aversion arising from observing a *qabīḥ* act (al-Rāghib), glossed as the severest form of *ibghāḍ* (transmitting Zajjāj) | *ashaddu al-ibghāḍ* (transmitting Zajjāj); aversion-distance rather than approach-aggression | purely evaluative moral aversion |
...
| 2 | ʾsf | 5 | 5 | 0 | 1.00 [0.57, 1.00] | Underpowered; CI *includes* the 0.74 baseline (raw *p* = 0.34, n.s.) |
| 3 | nqm | 17 | 12 | 5 | 0.71 [0.47, 0.87] | CI includes baseline; not Holm-significant |
| 3 | sxṭ | 4 | 0 | 4 | 0.00 [0.00, 0.49] | CI excludes baseline; Holm-adj. = 0.0505 (near-miss, n.s.) |
...
| 5 | ghyẓ | 11 | 3 | 8 | 0.27 [0.10, 0.57] | Medinan-tilted; Holm-adj. ≈ 1.9 × 10⁻² — survives Holm (FWER) |
| 6 | bghy | 96 | 55 | 41 | 0.57 [0.47, 0.67] | CI excludes baseline; Holm-adj. ≈ 5.3 × 10⁻³ — survives Holm (FWER); bridge node (Section 3.8.5) |
| 6 | ṭghy | 39 | 29 | 10 | 0.74 [0.59, 0.85] | CI includes baseline; not Holm-significant |
| 6 | ʿtw | 10 | 9 | 1 | 0.90 [0.60, 0.98] | CI includes baseline; *istikbār*-attached |
| **Σ** | — | **312** | **183** | **129** | — | |

Seven of the fourteen roots have *n* < 10 (*ʾff* = 3, *ʾsf* = 5, *sxṭ* = 4, *mqt* = 6, *ḥrd* = 1, *ghyẓ* = 11 is borderline, *ʿtw* = 10 borderline); per-root inferences on these are underpowered and we lead them with the Wilson-score CI rather than the *p*-value, the Holm-Bonferroni adjustment then carrying the inferential weight across the family. No substantive claim rests on a single underpowered root in isolation.
...
![**Figure 3.** Stacked Meccan/Medinan distribution. Three roots survive Holm-Bonferroni correction (α = 0.05): *karh* (Medinan), *baghy* (Meccan), and *ghayẓ* (Medinan); *sakhaṭ* a near-miss at adj. *p* = 0.0505 (not significant). *Asaf*, *naqm*, *ʿutuww* tilts are contextual. The patterns instantiate *discursive-contextual specialisation* (Section 4.4).](fig3_meccan_medinan.pdf){width=95%}

![**Figure 5.** Morphological profile by POS. Verbal dominance at S1–2 (*ḥzn* 88% verbal, *ḍyq* 62%), nominalisation at S4 (*ghḍb* 16n/6v/2 ptcp), peak nominality with participial forms at S6 (*ṭāghūt*, *bāghin*). The verbal→nominal gradient is independent corpus-internal evidence for the action-intensity continuum.](fig5_morphology_stack.pdf){width=95%}
...
**3.7.1. *Ghayẓ* and the *kaẓm* metaphor (11; 3M/8Md; Holm-adj. ≈ 1.9 × 10⁻² — survives Holm (FWER)).** The four lexica converge: *ghayẓ* is compressed contained anger (al-Rāghib), the highest concentration of restrained anger (al-Mostafawi), filling of the self with restrained anger (Ibn Manẓūr) — pressurised contents of a sealed vessel. Sūrat Āl ʿImrān (Q. 3:134) commends *al-kāẓimīn al-ghayẓ*; *kaẓm* derives from the tying-off of a waterskin (Ibn Manẓūr, *Lisān* 12:519, s.v. *k-ẓ-m*), the agent-internal regulation that sustains containment. The construction itself presupposes that the believers being commended experience the *ghayẓ* they suppress; the Narimani et al. claim that *ghayẓ* in human reference is exclusive to unbelievers must therefore be qualified — transitive *ghayẓ directed at* believers is exclusively non-believer-attributed, but intransitive/experiential *ghayẓ* (the *kāẓimīn* themselves) is attributed to believers. Read through the complex container metaphor of Section 2.1.3, *ghayẓ* is the contained fluid and *kaẓm* the agent's sealing operation (Figure 6). The Medinan tilt tracks the discursive context: inner anger management is a salient pedagogical concern in the formative Medinan community.

**3.7.2. *Tamayyuz* in sūrat al-Mulk, Q. 67:8 (manifestation, not separate root).** The verb *tamayyazu* in *takādu tamayyazu min al-ghayẓ* (Q. 67:8) walks from the *lughawī* gloss to the CMT construal in two steps. *First*, the lexicographic ground: in *Mufradāt* and *Lisān*, the dominant gloss of *m-y-z* is *al-tafrīq bayna al-mukhtaliṭ* — separating things that have been mixed; al-Ṭabarī (*Jāmiʿ al-bayān* ad loc.) glosses *yanqaṭiʿu baʿḍuhā min baʿḍ*; al-Zamakhsharī (*al-Kashshāf* ad loc.) is convergent. *Second*, the metonymic bridge, which we set out as an image-schematic inference rather than assert. The lexical core of *tamayyuz* is SEPARATION-OF-CONSTITUENTS *internal to* a bounded region (*al-tafrīq bayna al-mukhtaliṭ*; *yanqaṭiʿu baʿḍuhā min baʿḍ*). Mapped onto the PRESSURIZED-CONTAINER source of Section 2.1.3, an internal severance of the contents of a sealed, over-pressurised vessel is an *internal-disintegration* failure mode: the boundary's integrity is overwhelmed from within, in contrast to the *exit/overflow* failure mode of the English exemplars (*she blew her top*; *he erupted*), where the container is preserved and the hot contents escape through an opening. The discriminating feature is thus the *locus* of failure (inside vs. at the boundary), recoverable from the lexicographic sense without appeal to translator intuition. One co-textual qualification must be stated plainly: the grammatical subject undergoing *tamayyuz* at Q. 67:8 is the Hell-fire (*al-nār*), not the human body-vessel of the Q. 3:134 *ghayẓ–kaẓm* scenario; on Ibn ʿĀshūr's reading (*al-Taḥrīr wa-l-Tanwīr* 29:25) rage is figuratively attributed to the Fire as an animate rager. We therefore do not claim that Q. 67:8 instantiates the *same* body-as-container token as Q. 3:134; rather, the verse projects the human anger-vessel schema onto an animate Hell, and it is the *internal-separation construal of the vessel-failure mode* — not a shared bodily referent — that crystallises stage (4) of the scenario. Read this way, Q. 67:8 is a transparent Arabic instance of a rare INTERNAL-SEPARATION variant of PRESSURIZED-CONTAINER ANGER, attested also (as Section 4.5 concedes) at Job 32:19 (*bāqaʿ*); H5 is *exemplified* rather than corroborated — Q. 67:8 is the most lexically transparent Qur'anic instance, not a deductive proof, and not a unique one. We treat *tamayyuz* as a manifestation of Stage 5.[^qiraat-mulk-q67]

[^qiraat-mulk-q67]: The canonical *qirāʾāt* tradition records minor morphophonological variation on the verb form (the *mutawātir* reading is *tamayyazu*, an assimilated form of *tatamayyazu*; some readers restore the full *tatamayyazu*), but the underlying root sense — *m-y-z*, separation of what was mixed — is invariant across the canonical readings, so nothing in the construal turns on the variant.

### 3.8. Stage 6 — Behavioural Outcomes

**3.8.1. *Baghy* (96; 55M/41Md; Holm-adj. ≈ 5.3 × 10⁻³ — survives Holm (FWER)).** The most frequent lexeme of the spectrum and principal bridge node. Glossed as "seeking beyond rightful bounds" (al-Rāghib) and "aggressive seeking with intent to oppress" (al-Mostafawi). Sūrat al-Shūrā (Q. 42:42) collocates *baghy* with *ẓulm*; al-Ṭabarī (*Jāmiʿ al-bayān* 21:548 ad loc.) glosses *yabghūna* as *yataʿaddawn*, reading the verse as juridically restricting recourse to those who combine oppression and *baghy*-style transgression (al-Qurṭubī, *al-Jāmiʿ* 16:36, convergent). Ibn ʿĀshūr (*al-Taḥrīr* 25:126) clarifies: *baghy* and *ẓulm* are near-synonymous, but *baghy* is specific to non-rightful aggression against another whereas *ẓulm* covers all injustice.

**3.8.2. *Baghy* as bridge node.** *Baghy* attains the highest point-estimate closeness centrality (0.55) and shared-highest betweenness (0.15) with *ghaḍab* and *asaf*. Bootstrap 95% percentile CIs (1,000 ayat-resamples) are wide — for *baghy*: betweenness ∈ [0.00, 0.31]; closeness ∈ [0.23, 0.84]; eigenvector ∈ [0.00, 0.68] — reflecting the small graph (14 nodes). On strict non-overlap, no node's centrality is significantly greater than another's. What is *robust* at the aggregate level is cross-field connectivity to the umbrella moral terms (Table 4): *baghy* shows sixteen aya-level co-occurrences with *ẓlm/jrm/fsq/ʿdw/šnʾ* combined, an integer-count pattern independent of centrality ranking.

**Table 4.** Cross-field co-occurrence of spectrum roots with umbrella moral terms (aya-level), recomputed directly from `umbrella_cooccurrence.csv`. All roots with at least one cross-field tie are shown; the remaining spectrum roots (*ʾff*, *mqt*, *ḥard*, *ʿtw*) record zero ties and are omitted.
...
Of the thirty-eight cross-field ties recorded in the source table, sixteen (~42%) involve *baghy* — making it the single largest lexical bridge between the anger field and the wider moral-evaluation field, though it does not account for a majority of ties.
...
**3.8.4. *ʿUtuww* (10; 9M/1Md; Holm-adj. *p* = 1.00 — not Holm-significant).** The most extreme lexeme — "obstinate excess" (Ibn Manẓūr), "extreme self-aggrandisement in disobedience" (al-Rāghib). Sūrat al-Furqān (Q. 25:21) collocates *ʿatū ʿutuwwan kabīrā* with *istakbarū fī anfusihim*: rebellion crystallised into existential posture. The 9/1 split tracks the lexeme's rhetorical function as terminal designation for Nūḥ-, ʿĀd-, Thamūd-, and Pharaonic-people narratives but is not distinguishable from the baseline under the binomial.
...
*Coding protocol.* The primary coding pass over all 145 attestations was performed by the corresponding author — an Arabic-language specialist with graduate training in Qur'anic lexicology and *tafsīr* — against the three-label codebook, blinded to the bidirectional-causation hypothesis at the coding stage (root identity is intrinsic to the textual context and cannot be blinded). A second coder (an Arabic-literature graduate trained on the codebook with commentary excerpts) independently re-coded a stratified 20% sample (n = 29) drawn across the three Stage-6 roots; on this double-coded subsample Cohen's κ = 0.79 — *substantial* agreement (Landis and Koch 1977). Inter-coder disagreements on the verified subsample were reconciled by joint re-reading against the four commentaries. We report this single inter-rater statistic and do not claim per-label, per-root, or confusion-matrix breakdowns, which the 20%-sample design does not support at stable cell counts. The aggregate per-root and per-label counts below are the corresponding author's full-pass codings. The complete list of all 145 Stage-6 attestations — with verse references (sūra, āya, sūra name) and verse text extracted from the corpus, the documented three-label codebook, and the four-*tafsīr* 3-of-4 majority decision rule — is deposited as `data/concordance/stage6_causation_coding.csv`, together with the audit script `analysis/audit_stage6_causation.py` (a scipy-free reproduction of the aggregate counts, per-root breakdown, the 3×3 confusion matrix, and Cohen's κ). The per-verse A/S/A+S code values in that worksheet are the corresponding author's *tafsīr* judgments, entered by hand rather than auto-generated; from those entered codes the committed script deterministically regenerates the aggregate and per-root counts (and, where the second-coder column is populated, the confusion matrix and κ). The tooling, the full attestation list, and the decision rule are thus public and the aggregates are reproducible once the codes are in place; the verse-level judgments themselves remain author-supplied (Section 4.9).
...
**Appraisal theory: Scherer's checks and Roseman's *ṭughyān*-pattern.** Appraisal theory (Frijda 1986; Lazarus 1991; Scherer 2001, 2005; Roseman 1996) holds that emotional response is determined not by stimulus alone but by cognitive *appraisal* along defined dimensions. Scherer's component-process model specifies four sequential checks; the Stage-3 lexemes operate as a lexicon for the normative-significance check at progressively higher intensities (*naqm* → *sakhaṭ* → *maqt*). Sūrat al-ʿAlaq (Q. 96:6–7) conditions *ṭughyān* on the appraisal of *istighnāʾ*: the agent perceives high coping potential, low external constraint, and self-agency. On Roseman's (1996) appraisal structure, defiance and contempt are *other-caused* and *motive-inconsistent* (the agent rebels against an other-imposed normative constraint perceived as inconsistent with the agent's self-conception). *Ṭughyān* on *istighnāʾ* fits this pattern: the divine command is the other-caused, motive-inconsistent constraint that *istighnāʾ* construes as dispensable. The Qur'anic lexicon thus exhibits — at the level of its semantic surface, not as explicit theory — structural patterns that appraisal theory later articulated. We intend these correspondences as *comparative* and structural, and explicitly disclaim retrojection: we do not hold that the Qur'an states, anticipates, or contains modern emotion science, nor that the modern frameworks are validated by the parallel. The mappings are offered as a heuristic bridge for readers who work in both registers, and the direction of explanation runs from the classical lexicographic-exegetical evidence (which is primary) to the modern vocabulary (which is illustrative). Plutchik's three-level model, moreover, is a *cross-emotion* intensity schema rather than an anger-specific taxonomy, so the claim that the continuum "refines" it is a claim about lexical resolution within one emotion family, not a correction of Plutchik's general scheme.
...
The Qur'anic *ghayẓ–kaẓm–tamayyuz* triad maps onto stages (2)–(4) of the Lakoff–Kövecses scenario with unusual lexical transparency at stage (4): English exemplars (*blew his top*) lexicalise the failure-mode as *exit of contents* with the container preserved, whereas Q. 67:8, under the complex container metaphor of Section 2.1.3, supports the construal of vessel-internal failure (Section 3.7.2). A six-tradition survey contextualises the claim. *Akkadian*: *libbu* "heart, inside" (CAD L, s.v. *libbu*, 163–164) and *kabattu* "liver, inner seat of emotion" as filled containers of anger (Bodi 2018; the Neo-Assyrian bodily-mapping work in Lahnakoski et al. 2024 confirms the FILLING/HEAT-IN-CONTAINER schema for emotional semantics). *Biblical Hebrew*: *ḥēmâ* and *ḥarôn-ʾaph* (Kruger 2000, 2015) both EXIT-typed — except Job 32:19 (*kĕ-yayin lōʾ-yippātēaḥ … yibbāqēaʿ*), where *bāqaʿ* names the structural failure of the vessel; this is the one clear pre-Qur'anic Northwest-Semitic precedent. *Homeric Greek*: *kholos* and *mēnis* in fluid-and-heat schemas with no Iliadic vessel-rupture (Muellner 1996; Cairns 2003). *Vedic and Classical Sanskrit*: *krodha* and *manyu* in FIRE and WEAPON-RELEASE schemas, not vessel-disintegration. *Classical and Modern Chinese*: *nù*, *fèn*, *qì* with HOT *QÌ* IN A CONTAINER (Yu 1995; Kövecses, Benczes, and Szelid 2025). *Pre-Islamic Jāhilī Arabic*: *ḥamiya* and *ghalā* alongside *ghayẓ* in the cognate fluid-heat register (cf. *al-Mufaḍḍaliyyāt* nos. 38, 87, ʿAntara's *Muʿallaqa* ll. 32–35; Webb 2016, 213–245). Across the cited corpora, the exemplars we are aware of concentrate on filling, heating, and exit/overflow; the Hebrew Bible (Job 32:19) offers the one clear parallel to vessel-rupture proper. These are statements about the exemplars we have surveyed, not established negatives about whole traditions: we do not claim that no internal-separation exemplar exists in Vedic, Homeric, or Chinese anger lexis, only that we have not located a clear one in the cited sources. For the same reason we frame the relation to the two-volume *Metaphors of ANGER across Languages* (Kövecses, Benczes, and Szelid 2025) cautiously: that handbook surveys some twenty-two languages but does not canvass Classical Arabic, so our contribution is to *add* a Classical-Arabic data point exhibiting an internal-separation variant, not to assert that no surveyed language attests such a variant. We accordingly hold our claim at "an early and unusually transparent" lexicalisation — not a unique one — with Job 32:19 (*bāqaʿ*) acknowledged as a structurally cognate Northwest-Semitic precedent. So qualified, the Qur'anic data are consistent with the universalist hypothesis of CMT and extend its empirical base to seventh-century Arabic.
...
### 4.6. The Theology of Divine Anger: Affect, Action, and the Limits of Predication

The continuum carries a theological consequence that distinguishes this study from a purely psychological taxonomy, and it bears on the central question the topic raises for a religious-studies readership: in what sense may anger be predicated of God? Several spectrum lexemes are attributed to God in the Qur'an — *ghaḍab* (sūrat al-Fatḥ, Q. 48:6), *maqt* (sūrat Ghāfir, Q. 40:10; sūrat al-Ṣaff, Q. 61:3), *sakhaṭ* (sūrat Muḥammad, Q. 47:28), and the retributive *naqm* underlying the divine Name *al-Muntaqim* — and each is a *mutashābih* (ambiguous) attribute that the *kalām* tradition treats under the doctrine of divine *tanzīh* (transcendence above creaturely affect). The Muʿtazilī reading, represented in al-Zamakhsharī's *al-Kashshāf*, declines to attribute *infiʿālī* (passively-aroused, affective) states to God and reads divine *ghaḍab*/*sakhaṭ* as a figure (*majāz*) for the *will* to punish or for the punishment itself; al-Rāzī (*Mafātīḥ al-Ghayb*) converges in glossing divine *ghaḍab* as *irādat al-ʿuqūbah* — an act of normative-juridical will, not a perturbation of the divine self — while the Ashʿarī and Māturīdī mainstream preserves the attribute *bi-lā kayf* (without specifying modality) yet still construes it as oriented to consequence rather than to embodied feeling. Al-Ṭabāṭabāʾī (*al-Mīzān*) likewise reads divine *ghaḍab* as a *maqām* (station) of action — the standing-back of mercy and the onset of recompense — rather than as an affect.

The action-intensity continuum gives this debate a precise lexical shape. The lexemes predicable of God cluster at the *action-tilted, evaluative* poles of the spectrum — *naqm* (retribution-oriented), *sakhaṭ* (declarative ethical disapprobation), *maqt* (purely evaluative aversion), and *ghaḍab* (in its *irādat al-ʿuqūbah* construal) — precisely the stages whose lexicographic glosses foreground judgement and consequence over embodied arousal. By contrast, the *affective–embodied* upper register of the continuum — *ghayẓ* as the high-pressure filling of a sealed vessel, and above all the vessel-internal collapse of Q. 67:8 (*takādu tamayyazu min al-ghayẓ*) — is in the Qur'an reserved for creatures (and, at Q. 67:8, projected onto the Hell-fire construed as an animate rager; Section 3.7.2), never predicated of God. This asymmetry is theologically load-bearing: the very PRESSURIZED-CONTAINER complex metaphor that the cognitive-linguistic analysis foregrounds is, on the Qur'an's own usage, a *creaturely* construal, and its non-applicability to God is exactly what the *tanzīh* tradition would predict. The continuum thus does more than rank emotion words; it draws a line, internal to the lexicon, between the action-oriented aversion that classical theology permits of God and the affective-somatic rage that it does not. Reading the spectrum theologically rather than only psychologically is what secures its purchase as a contribution to Qur'anic theology, and not merely to comparative emotion science.

### 4.7. Implications for Qur'anic Translation

A graded reference model of the spectrum offers a principled corrective to the levelling pattern that Gaanoun and Alsuhaibani (2025) and Al-Shidi et al. (2025) document at the sentiment-category level. We do not, on the strength of the four-verse illustrative sample of Section 3.10, advance translation prescriptions; a systematic stratified evaluation (~30 verses across the six stages, multi-rater coded against the spectrum) is the prerequisite. Candidate equivalents for each spectrum lexeme are catalogued in the project repository for use by translators wishing to mark intensity-position lexically.

### 4.8. Implications for Islamic Psychology
...
Five limitations bound the inferences. (i) *Surface-lexical scope*: discourse-analytic close-reading of the spectrum's narrative deployment across suras is left for future work. (ii) *Tafsīr engagement and audit reproducibility*: a deep-dive indexing the full classical/medieval/Sufi/modernist tradition with multi-coder reading on contested verses would deepen exegetical grounding. For the Stage-6 causation audit (Section 3.8.5), the regeneration script (`analysis/audit_stage6_causation.py`) and the complete 145-attestation worksheet (`data/concordance/stage6_causation_coding.csv`, with verse references and the documented four-*tafsīr* decision rule) are now deposited, so the aggregate per-root/per-label counts regenerate deterministically from the entered codes; what remains author-supplied is the per-verse A/S/A+S judgment for each attestation, and the inter-coder κ = 0.79 was computed on a single-coder full pass plus a 20% second-coder verification sample rather than full double-coding of all 145 attestations. The aggregate Stage-6 breakdown should accordingly be read as a single-coder classification with a substantial-agreement reliability check on a subsample, not as a fully double-coded audit; a complete two-coder coding of all 145 attestations with per-label and per-root κ and a confusion matrix is left for future work. (iii) *Cognitive-linguistic apparatus*: engagement with classical *bayān* theory (al-Jurjānī, al-Sakkākī) would supply an indigenous substrate. (iv) *Ḥadīth integration*: a parallel concordance over Ṣaḥīḥ al-Bukhārī, Ṣaḥīḥ Muslim, and al-Kāfī would supply convergent evidence on *kaẓm* and a replication test for the underpowered *asaf* distribution. (v) *Islamic-psychology operationalisation*: Section 4.8's implications await pilot studies of *kaẓm*-grounded emotion-regulation training, validated against the STAXI and DERS. Small per-root *n* and the closed-text status of the corpus bound every inference reported above; computational evidence remains a complement to, not a replacement for, the classical philological and exegetical tradition.

---

## 5. Conclusions

*Methodologically*, the integration of Izutsu's semantic-field analysis, Kennedy–Sassoon scalar semantics, and Lakoff–Kövecses CMT — coupled with a reproducible computational pipeline over the QAC — yields a layered apparatus in which each framework does separable work (lexicography/Izutsu order the field and licence the partition; scalar semantics models the graded dimension; CMT illuminates the upper-stage container complex; see Section 2.1.4). To our knowledge this trifold integration has not been deployed in Qur'anic studies, although Qāʾimīniyā (2011, 2014) and Pakatchi and Afrashi (2020) have integrated Izutsu and CMT; we present the corpus apparatus as corroborative — and, at the omnibus, trend, and embedding tests, candidly null — rather than as the primary evidentiary engine, which remains the classical philological and exegetical record.

*Descriptively*, we produce a reproducible concordance of 312 attestations with Holm-Bonferroni-adjusted (family-wise-error-controlling) binomial tests, marginal-preserving permutation null *p*-values, and bootstrap 95% CIs on every centrality estimate.

*Theoretically*, we formulate and defend the *Qur'anic Action-Intensity Continuum Hypothesis*: the fourteen lexemes operate as a single graded continuum structured by intensity of action and partitioned into six stages, supported by qualitative evidence from the four authoritative lexica and the broadened *tafsīr* consultation, and by quantitative evidence from frequency, distribution, morphology, and network structure. The *tafsīr*-coding audit (second-coder κ = 0.79 on a 20% verification sample) grounds the bidirectional-causation reading of Stage 6; the six-tradition survey of Section 4.5 calibrates Q. 67:8 as an early and unusually transparent — rather than uniquely transparent — exemplification of vessel-internal failure, with Job 32:19 (*bāqaʿ*) acknowledged as a structurally cognate Northwest-Semitic precedent.

In answer to the research questions: the anger-spectrum field is a fourteen-node lexical network organised by intensity of action, with *baghy* the bridge node (closeness 0.55; ~42% of cross-field ties, the single largest share) and stage-internal hubs *ḥuzn* (S2) and *ghaḍab* (S4) (RQ1–RQ2); the empirical distribution is *consistent with* the continuum — asymptotic χ²(5) = 227.15, permutation null *p* = 0.24, S1–5/S6 χ²(1) = 1.55, with three roots (*karh*, *baghy*, *ghayẓ*) surviving Holm-Bonferroni and *sakhaṭ* a non-significant near-miss (adj. *p* = 0.0505) (RQ3); the continuum is structurally homologous (comparatively, not by retrojection) with Gross (S1–5), Plutchik, Spielberger, and Lazarus–Scherer–Roseman appraisal theory, and reaches at Stage 6 into a moral-anthropological register that lies beyond the episode-bounded scope of those models (RQ4); and conditional implications follow for Qur'anic translation and Islamic psychology (RQ5). The Qur'anic lexicon encodes a sophisticated theory of the anger spectrum in the architecture of its semantic surface; recovering it requires the integration of classical philological attentiveness, contemporary linguistic-theoretical precision, and corpus-computational verifiability. Future work should pursue discourse-analytic close-reading, deeper *tafsīr* indexing, engagement with classical *bayān* theory, ḥadīth-corpus replication, and clinical operationalisation of the *kaẓm* construct.
...
Albayrak, Ismail. 2012. "The Reception of Toshihiko Izutsu's Qurʾānic Studies in the Muslim World: With Special Reference to Turkish Qurʾānic Scholarship." *Journal of Qurʾanic Studies* 14 (1): 73–106.
...
Khaleefah, Talal. 2016. "Anger, Wrath, and Irritation in the Holy Quran: A Semiotic Study." *Alustath Journal for Human and Social Sciences* 216 (1): 55–76. https://doi.org/10.36473/ujhss.v216i1.587.
...
Lahnakoski, Juha M., Ellie Bennett, Lauri Nummenmaa, Ulrike Steinert, Mikko Sams, and Saana Svärd. 2024. "Embodied Emotions in Ancient Neo-Assyrian Texts Revealed by Bodily Mapping of Emotional Semantics." *iScience* 27 (12): 111365.
...
Narimani, Zahra, Masoud Iqbali, and Mostafa Chari. 2021. "Semantic Re-analysis of the Words *ghayẓ*, *ghaḍab*, and *sakhaṭ* in the Holy Qurʾān with an Exegetical Approach" [in Persian]. *ʿUlūm-i Qurʾān va Ḥadīth* [Quranic Sciences and Tradition] 54 (1): 219–39.
...
Al-Shidi, Alia, Farah Hani Bt Nordin, Izzeldin I. Mohamed, M. A. Younis, Imadeldin E. Elmutasim, and Eimad Eldin Abusham. 2025. "A Literature Review on Natural Language Processing Techniques for Qurʾānic Studies: Challenges and Insights." *Frontiers in Signal Processing* 5: 1535166. https://doi.org/10.3389/frsip.2025.1535166.
...
Solihu, Abdul Kabir Hussain. 2009. "Semantics of the Qurʾānic *Weltanschauung*: A Critical Analysis of Toshihiko Izutsu's Works." *American Journal of Islamic Social Sciences* 26 (4): 1–23.

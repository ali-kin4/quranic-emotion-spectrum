...
def fig5_morphology() -> None:
    ...
    ax.set_title("Figure 5.  Morphological breakdown of spectrum lexemes "
...
def fig6_metaphor() -> None:
    ...
    # Central frame title
    ax.text(5, 7.6, "Figure 6.  ANGER IS A PRESSURIZED CONTAINER",
...
def fig7_centrality() -> None:
    ...
    fig.suptitle("Figure 7.  Network-centrality measures on the aya-level "

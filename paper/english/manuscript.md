...
The paper's claim to **originality** rests on five distinct contributions, framed throughout in "to our knowledge" terms rather than as priority claims: (i) the systematic integration of Izutsu, Kennedy, and Lakoff under a single corpus-empirical pipeline in Qurʾānic studies—an integration we have not encountered, but which we cannot rule out in the Persian-language or non-English Qurʾānic-linguistic literature; (ii) a fully reproducible computational pipeline over the Quranic Arabic Corpus, released open-source; (iii) the corpus-distributional documentation of the exclusively-Medinan distribution of *sakhaṭ*, the exclusively-Meccan distribution of *asaf*, and several allied tilts (*naqm*, *ʿutuww*, *ḥard*), which we have not seen reported elsewhere as a systematic pattern; (iv) the network-centrality demonstration that *baghy* operates as a high-closeness bridging node between the anger field and the broader moral-evaluation field of the Qurʾān; and (v) the substantive argument that Q. 67:8 (*takādu tamayyazu min al-ġayẓ*) furnishes an unusually transparent linguistic instance of the "container collapse" failure-mode identified by Lakoff and Kövecses (1987)—a comparative claim we soften, in §5.6, with the explicit observation that no comprehensive cross-cultural survey of historical anger-vessel imagery has yet been conducted (cf. A6 below).
...
**Cognitive-semantic studies** in the Izutsu tradition—most notably Qāʾimīniyā's *Maʿnāshināsī-yi Shinākhtī-yi Qurʾān* (Tehran: Pizhūhishgāh-i Farhang va Andīshah-i Islāmī, 1390/2011) and his *Istiʿārah-hā-yi Mafhūmī wa Faḍāhā-yi Qurʾānī* (1393/2014); the Izutsu-revival critical-analysis literature (e.g. Albayrak 2020 in *American Journal of Islam and Society*); and Pakatchi and Afrashi's *Rūykardhā-yi Maʿnā-shinākhtī dar Muṭālaʿāt-i Qurʾānī* (1399/2020)—have begun to apply cognitive linguistics to Qurʾānic vocabulary. To our knowledge, no published work has yet treated the anger-spectrum field as a graded continuum and validated it against full-corpus evidence. The cross-linguistic conceptual-metaphor literature on anger is now substantial: Yu's (1995) classic study of English vs. Chinese anger metaphors; Soriano's (2005) doctoral analysis of English vs. Spanish; Maalej (2004) on conceptual metaphor in Tunisian Arabic anger expressions; the comparative volume Maalej & Yu (eds., 2011); and recent contrastive corpus studies of Arabic-English anger metaphor (Rabab'ah & Al-Saidat 2022 in *Cognitive Semantics*; Derki 2022). With the exception of Maalej (2004), all focus on contemporary spoken or written language rather than the Qurʾānic register; none, to our knowledge, has approached the field as a graded continuum validated against full-corpus evidence.

**Translation-criticism studies** observe the levelling tendency of translations and identify it as a structural defect. Recent computational work makes this concern quantitative: Almuhanna et al. (2025) show that reputable English translations of the Qurʾān exhibit systematic sentiment-leakage on emotion-bearing verses, and the multilingual ELQV dataset of emotionally-labelled Qurʾānic verses (2,100 verses; cf. Authors 2025 in *J. King Saud Univ. CIS*) is built precisely to make levelling auditable. These works share the diagnostic stance of the present paper but lack a graded reference model of the lexical spectrum against which translation-side levelling can be benchmarked.
...
Aggregating across the six stages: Stage 1 = 44; Stage 2 = 60; Stage 3 = 27; Stage 4 = 25; Stage 5 = 11; Stage 6 = 145. The chi-squared test against the null of uniform six-stage distribution rejects (χ²(5) = 227.15, *p* < 0.001), confirming H1. We note that this omnibus test confirms only that the six-stage distribution is non-uniform; it does *not*, on its own, validate the specific monotonic ordering of stages along the action-intensity continuum. A discriminating test of monotonicity is reported in §4.2.1 below. A complementary chi-squared test against the null of equal split between the phenomenological core (Stages 1–5 = 167 attestations) and the behavioural-outcomes pole (Stage 6 = 145 attestations) *fails to reject* (χ²(1) = 1.55). Because failure to reject a null is *absence of evidence of a difference* and not evidence of equality, we report this result not as positive corroboration of H2 but as a finding *consistent with* the reading developed in §4.8.5 and §5.4: the Stage-6 lexemes (*baghy*, *ṭughyān*, *ʿutuww*) are not exclusively anger-derived but stand in a *bidirectional* causal relation to the anger spectrum—anger may produce these behaviours, but the behaviours can equally produce anger (in their victims, the prophets, and the divine response). The test is, with these sample sizes, underpowered to discriminate between competing models of the Stage 1–5 ↔ Stage 6 relation; the substantive interpretation rests on the qualitative tafsir-grounded analysis of §4.8.5, not on the statistical near-balance.

#### 4.2.1. Monotonic-trend test for the six-stage ordering

Because the χ²(5) test confirms non-uniformity but not the specific ordering of stages, we report two complementary tests of monotonicity. (i) A *Spearman rank-correlation* between stage index (1–6) and per-stage attestation count is positive but not monotone: the count rises from S1 (44) to S2 (60), drops through S3–S5 (27, 25, 11), then jumps to S6 (145); the resulting rank correlation is ρ = +0.20, *p* > 0.5. (ii) A *Jonckheere–Terpstra-style* test of monotone increase across S1→S6 is therefore non-significant. We read this as expected, and important: the action-intensity continuum is *not* claimed to be a monotone-increasing frequency function, since the Qurʾān's pedagogical emphasis at the lower-intensity (S1–2) and behavioural-outcome (S6) poles is theoretically motivated rather than indexical of intensity. The continuum claim is an ordering of *semantic intensity*, not of *attestation frequency*; the monotonicity test is included here transparently to forestall the misreading that frequency alone validates the continuum order. The qualitative tests of ordering (lexicographic, exegetical, metaphorical) reported in §4.1 and §4.3–§4.8 are the load-bearing evidence for the continuum's structure.
...
***Baseline sensitivity.*** With n = 4, the inference is mildly sensitive to the baseline. We report the two-sided exact binomial p-value at three baselines bracketing the conventional range:
...
The conclusion is robust across this range: with n = 4 and 0/4 Meccan, the two-sided exact binomial test rejects the null of a 0.70–0.78 Meccan rate at α = 0.05. We caution, however, that with n = 4 the test is by construction underpowered against subtler alternatives, and the *substantive* claim of discursive specialisation (developed below) rests on the convergence of distributional evidence with the contextual-tafsir reading of all four occurrences, not on the binomial test in isolation.
...
**Theoretically**, we have formulated and empirically defended the **Qurʾānic Action-Intensity Continuum Hypothesis**: the claim that fourteen core lexemes of the Qurʾānic anger-spectrum field operate as a single graded continuum structured by *intensity of action* and partitioned into six phenomenologically meaningful stages. The hypothesis is supported by qualitative evidence from the four authoritative lexica and from a now-broadened tafsir consultation (§3.5), and by quantitative evidence from frequency, distribution, morphology, and network structure. We have, in addition, identified distributional patterns that we have not seen previously reported as a coordinated set—the exclusively-Medinan *sakhaṭ* (statistically significant at *p* = 0.005, robust under baseline sensitivity); the exclusively-Meccan *asaf* (suggestive but not statistically established at n = 5); the Meccan-tilted *naqm*; the hapax-Meccan *ḥard*; the Medinan-tilted *karh*—and proposed the general phenomenon of **discursive-contextual lexical specialisation** of which these are instances. We have entered explicit caveats on the bidirectional causation of the Stage-6 lexemes (§4.8.5), and argued that Q. 67:8 furnishes an *unusually transparent* linguistic exemplar of "container collapse"—a comparative claim whose strong universalist form is reserved pending the cross-cultural philological survey we commend in §5.6 and §6.3.
